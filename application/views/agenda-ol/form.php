<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#simpan").click(function(){
            ...
            $.ajax({
                type	: 'POST',
                url		: "<?php echo site_url(); ?>/agenda/simpan",
                data	: string,
            ...
            <div class="box-content nopadding">
                ...
                -->
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="lokasi" id="lokasi" placeholder="Lokasi..." class="input-large" value="<?php echo $lokasi; ?>">
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="textfield" class="control-label">Mitra</label>
                        <div class="controls">
                            <div class="input-xlarge"><select name="mitra" id="mitra" class="chosen-select" required>
                                    <?php
                                    if(empty($mitra)){
                                        ?>
