            ...
            <div class="box-content nopadding">
                ...
                -->
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="name" id="name" placeholder="Acara..." class="input-xxlarge" value="<?php echo $name; ?>">
                        </div>
                    </div>
                    <div class="control-group">
				...
				<textarea name="lokasi" id="lokasi" rows="3" class="input-xxlarge"><?php echo $lokasi; ?></textarea>
                        </div>
                    </div>
                    <div class="control-group">
