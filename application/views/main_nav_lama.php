...
<li class='<?php if($judul == 'list_wbs' || $judul == 'add_wbs' || $judul == 'edit_wbs' || $judul == 'list_wp' || $judul == 'add_wp' || $judul == 'edit_wp'
    ...
    <ul class="dropdown-menu">
        <li>
            <a href="<?php echo base_url(); ?>index.php/stkk">STKK</a>
        </li>
        <li>
            <a href="<?php echo base_url(); ?>index.php/wbs">WBS</a>
        </li>
        <li>
            <a href="<?php echo base_url(); ?>index.php/wp">W P</a>
        </li>
        <li>
