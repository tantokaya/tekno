<div class="span9">
    <div class="box">
        <div class="box-title">
            ...
            <a href="<?php echo base_url(); ?>index.php/bidang/tambah">
        ...
        <div class="box-content nopadding">
            <table class="table table-hover table-nomargin table-bordered dataTable dataTable-nosort" data-nosort="0,4">
                ...
                <tr>
                    ...
                    <th width="100">Nama Bidang</th>                    
					<th width="100">Nama Kepala Bidang</th>
					<th width="150">Deskripsi Bidang</th>
                    <th width="40">Aksi</th>
                </tr>
                </thead>
                <tbody>
                ...
                foreach ($all_wbs as $db):
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <a href="<?php echo base_url();?>index.php/bidang/edit/<?php echo $db['wbs_id'];?>" class="btn btn-inverse" rel="tooltip" title="Edit">
                                <i class="icon-edit"></i>
                            </a>
                            <a href="<?php echo base_url();?>index.php/bidang/hapus/<?php echo $db['wbs_id'];?>"
