<div class="span9">
    <div class="box">
        <div class="box-title">
            ...
            <a href="<?php echo base_url(); ?>index.php/wp/tambah">
        ...
        <div class="box-content nopadding">
            <table class="table table-hover table-nomargin table-bordered dataTable dataTable-nosort" data-nosort="0,4">
                ...
                <tr>
                    ...
                    <th width="30" >Kode WP</th>
                    <th width="200">Nama WP</th>
					 <th width="200">Nama Leader</th>
                    <th width="40">Aksi</th>
                </tr>
                </thead>
                <tbody>
                ...
                foreach ($all_wp as $db):
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <a href="<?php echo base_url();?>index.php/wp/edit/<?php echo $db['wp_code'];?>" class="btn btn-inverse" rel="tooltip" title="Edit">
                                <i class="icon-edit"></i>
                            </a>
                            <a href="<?php echo base_url();?>index.php/wp/hapus/<?php echo $db['wp_code'];?>"
