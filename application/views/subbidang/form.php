...
<!--        }-->
       ...
       $("#simpan").click(function(){
            ...
            $.ajax({
                ...
                cache	: false,
                success	: function(data){
                    window.location.href = "<?php echo site_url(); ?>/subbidang";
                }
            });
            return false();
        });
...
<div class="row-fluid">
    <div class="span12">
        <div class="box box-bordered">
            <div class="box-title">
                <h3><i class="icon-th-list"></i> Form Sub Bidang</h3>
            </div>
            <div class="box-content nopadding">
                <form name="form" id="form" class='form-horizontal form-bordered'>
                        ...
                        <div class="controls">
                            <div class="input-xxlarge"><select name="wbs" id="wbs" class="chosen-select" required="true">
                                    ...
                                    foreach($l_wbs->result() as $t){
                                        if($wbs==$t->wbs_code){
                                            ?>
                                            <option value="<?php echo $t->wbs_code;?>" selected="selected"><?php echo $t->gabung;?></option>
                                        <?php }else{ ?>
                                            <option value="<?php echo $t->wbs_code;?>"><?php echo $t->gabung;?></option>
                                        <?php }
                                    } ?>
                                </select></div>
                        </div>
                    ...
                    <div class="control-group">
                        <label for="textfield" class="control-label">Kode Sub Bidang</label>
                        <div class="controls">
                            <input type="text" name="code" id="code" placeholder="Kode.." class="input-medium" value="<?php echo $code; ?>">
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="textfield" class="control-label">Nama Sub Bidang</label>
                        <div class="controls">
                            <input type="text" name="name" id="name" placeholder="Nama..." class="input-xxlarge" value="<?php echo $name; ?>">
                        </div>
                    </div>
					<div class="control-group">
                        <label for="textfield" class="control-label">Nama Kepala Sub Bidang</label>
                        <div class="controls">
